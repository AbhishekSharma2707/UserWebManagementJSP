...
<div class="abc">
<label><input type="checkbox" required>I hereby declare that the above information provided is true and correct</label><br><br>
<h3>You are already registerd please  <a href="http://localhost:8080/JSPwithJDBC/Login.jsp" >login now!</a></h3><br>
